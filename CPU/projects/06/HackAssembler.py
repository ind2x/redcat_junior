...
def comp(comp):
    comp_bit = ['101010', '111111', '111010', '001100', '110000', '001101', '110001', '001111', '110011', '011111', '110111', '001110', '110010', '000010', '010011', '000111', '000000', '010101']
    
    a0 = ['0', '1', '-1', 'D', 'A', '!D', '!A', '-D', '-A', 'D+1', 'A+1', 'D-1', 'A-1', 'D+A', 'D-A', 'A-D', 'D&A', 'D|A']
    
    a1 = {'M':4, '!M':6, '-M':8, 'M+1':10, 'M-1':12, 'D+M':13, 'D-M':14, 'M-D':15, 'D&M':16, 'D|M':17}
