...
def analyze(jackFile):
    ...
    with open(jackFile, 'r') as f:
        ...
        for line in lines:
            ...
            # compile classVarDec
            elif code[0].find('static') == 0 or code[0].find('field') == 0:
            ...
            # compile statements
            elif code[0].find('let') == 0 or code[0].find('if') == 0 or code[0].find('while') == 0 or code[0].find('do') == 0 or code[0].find('return') == 0 :
                ...
                # compile return statement
                    ...
                    if ' ' in code[0]:
                        ...
                        parsed_code = expression(code.group(1))
